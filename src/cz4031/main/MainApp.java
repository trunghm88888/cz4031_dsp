...
public class MainApp implements Constants {
	...
	public void run(int blockSize) throws Exception {
		...
		for (Record record: records) {
			...
			recordAddr = disk.appendRecord(record);
			index.insert(record.getNumVot(), recordAddr);
		}
...
//		index.logStructure(1); // printing root and first level?
	...
	public void doExperience3(){
		Log.i(TAG,"experiment 3 started, getting records with numVotes of 500");
	...
	public void doExperience4(){
		Log.i(TAG,"experiment 4 started, getting records with numVotes between 30k-40k ");
